...
public class ClientMainFX extends Application { 
    ...
    // CRÍTICO: Usando o mesmo IP do Servidor para a conexão
    private static final String RMI_HOST = "192.168.56.1"; 

    @Override
    public void start(Stage primaryStage) throws Exception {
        // Força o RMI a procurar o serviço no IP local
        ...
        try {
            ...
            System.err.println("Erro ao carregar FXML ou iniciar JavaFX. Verifique a estrutura de arquivos e o pom.xml.");
            e.printStackTrace();
        }
    }
